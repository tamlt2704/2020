...
class Timer extends Component {
    ...
    render() {
        //const elapsedString = `${Date.now() - this.props.elapsed}`;
        const runningSince = this.props.runningSince;
        const elapsedString = runningSince ? Date.now() - runningSince : this.props.elapsed;
        return (
